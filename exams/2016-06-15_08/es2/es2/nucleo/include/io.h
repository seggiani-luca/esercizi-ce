...
/**
 * @brief Lettura in DMA da una periferica CE.
 *
 * @param id		id della periferica
 * @param buf		buffer destinato a contenere i caratteri letti
 * @param quanti	numero di caratteri da leggere
 */
