...
/**
 * @brief Crea una nuova msg-area.
 *
 * @pre Il processo non deve possedere già una msg-area.
 *
 * @return 	puntatore alla msg-area, o nullptr in caso di errore
 */
extern "C" void* macreate();

/**
 * @brief Spedisce la msg-area ad un altro processo.
 *
 * @pre Il processo invocante deve possedere una msg-area.
 * @pre Il destinatario non può essere lo stesso del processo invocante.
 * @pre Il destinatario non deve essere un processo di livello sistema.
 *
 * Quando restituisce false, la primitiva lascia tutto inalterato.
 *
 * @param pid	id del processo destinatario
 *
 * @return 	false se il destinatario non esiste o
 * 		possiede già una msg-area, o in caso
 * 		di errore; true altrimenti
 */
