...
/// Massimo numero di rwlock
#define MAX_RW			100
/// Massimo numero di rwlock attivi per processo
#define MAX_PROC_RW		2
// ESAME 2024-09-11 )
/// @}
...
#define TIPO_RWR		0x2a	///< rw_writelock()
#define TIPO_RWW		0x2b	///< rw_readlock()
#define TIPO_RWU		0x2c	///< rw_upgrade()
#define TIPO_RWD		0x2d	///< rw_downgrade()
#define TIPO_RWI		0x2e	///< rw_init()
// ESAME 2024-09-11 )
/// @}
