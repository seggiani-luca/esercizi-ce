...
// [ ESAME 2025-01-27
/// @ingroup esame
/// @brief dimensione del buffer di ogni vce
#define VCE_BUFSIZE		4
//   ESAME 2025-01-27 ]
...
#define IO_TIPO_VN		0x48	///< vcenew()
#define IO_TIPO_VW		0x49	///< vcewrite()
#define IO_TIPO_VD		0x4a	///< vcedbg() (solo per debug e test)
//   ESAME 2025-01-27 )
/// @}
/// @}
...
#define INTR_TIPO_CE		0x70	///< periferiche CE
//   ESAME 2025-01-27 )
/// @}
