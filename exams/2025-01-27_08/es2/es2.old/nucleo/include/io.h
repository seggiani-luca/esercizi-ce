...
/**
 * @brief 	Crea la VCE del processo
 *
 * @pre il processo non deve avere già una VCE.
 *
 * @return 	false in caso di errore, true altrimenti
 */
extern "C" bool vcenew();

/**
 * @brief 	Scrittura di un byte sulla VCE del processo
 *
 * @pre Il processo deve avere una VCE.
 *
 * @param c		byte da scrivere
 */
extern "C" void vcewrite(char c);

/// Non usare: solo per debug e test
extern "C" natb vcedbg(natl testid, natl testlen, natb* testdata);
//   ESAME 2025-01-27 )
