...
a_wfi:
	...
	call salva_stato
// [ ESAME 2025-01-27
	call maybe_event	// questo e' il modo in cui si accede alla wfi
									 	// - ritorno true: non si fa la wfi
										//   (il proc. esterno torna in esecuzione)
										// - ritorno false: si fa la wfi normale
	cmp $0, %al
	jne skip_wfi
	call apic_send_EOI
	call schedulatore
