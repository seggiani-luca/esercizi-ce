...
/// @addtogroup usrheap Memoria dinamica
/// @brief Funzioni per l'utilizzo dello heap da parte del modulo utente
///
...
/// @addtogroup usrerr Gestione errori
/// @{
...
/// @addtogroup usrinit	Inizializzazione
/// @{
...
void lib_init()
{
	...
	heap_init(allinea_ptr(_end, DIM_PAGINA), DIM_USR_HEAP);
	flog(LOG_INFO, "Heap del modulo utente: %llxB [%p, %p)", DIM_USR_HEAP,
			_end, _end + DIM_USR_HEAP);
}
/// @endcond
/// @}
/// @}
