...
// costanti pipe
#define MAX_PIPES 10 // numero max di pipe totali
#define MAX_OPEN_PIPES 2 // numero max di pipe per processo
...
// primitive pipe
#define	TIPO_OP			0x2a	// openpipe()
#define	TIPO_WP			0x2b	// writepipe()
#define	TIPO_RP			0x2c	// readpipe()
#define	TIPO_CP			0x2d	// closepipe()
/// @}
