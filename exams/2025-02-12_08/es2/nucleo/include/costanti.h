...
// [ ESAME 2025-02-12
/// @ingroup esame
/// @brief Massimo numero di estremità di pipe aperte per processo
#define MAX_OPEN_PIPES		2
/// @ingroup esame
/// @brief Massimo numero di pipe nel sistema
#define MAX_PIPES		10
//   ESAME 2025-02-12 ]
...
#define TIPO_OPENPIPE		0x2a	///< openpipe()
#define TIPO_READPIPE		0x2b	///< writepipe()
#define TIPO_WRITEPIPE		0x2c	///< readpipe()
#define TIPO_CLOSEPIPE		0x2d	///< closepipe()
//   ESAME 2025-02-12 )
/// @}
