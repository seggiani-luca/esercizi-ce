 ...
 */
extern "C" natl activate_pe(void f(natq), natq a, natl prio, natl liv, natb irq);
 ...
 * @return	1: interruzione, 2: evento, 3: interruzione ed evento
 */
extern "C"  natq wfi();
//   ESAME 2024-07-17 )
...
/**
 * @brief Registra il processo per la ricezione delle notifiche di terminazione.
 *
 * @return true in caso di successo e false altrimenti (processo già registrato,
 * 	notifica in corso)
 */
extern "C" bool evreg();

/**
 * @brief Risponde ad eventuali notifiche.
 *
 * @return id di un processo terminato; 0 se il processo non è registrato o
