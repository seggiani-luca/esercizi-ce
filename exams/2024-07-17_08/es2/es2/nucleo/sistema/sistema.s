...
// ( ESAME 2024-07-17
	carica_gate	TIPO_ER		a_evreg		LIV_SISTEMA
	carica_gate	TIPO_EG		a_evget		LIV_SISTEMA
//   ESAME 2024-07-17 )
...
// [ ESAME 2024-07-17
	/// @ingroup esame
	/// @note se il processo ha ricevuto un evento torniamo
	/// dalla wfi() senza bloccarlo
	call maybe_event
	cmp $0, %al
	jne skip_wfi
	call apic_send_EOI
...
// ( ESAME 2024-07-17
	...
	.extern c_evreg
/// Parte Assembler della primitiva evreg()
a_evreg:
	.cfi_startproc
	.cfi_def_cfa_offset 40
	.cfi_offset rip, -40
	...
	.extern c_evget
/// Parte Assembler della primitiva evget()
a_evget:
	.cfi_startproc
	.cfi_def_cfa_offset 40
	.cfi_offset rip, -40
...
/// @ingroup esame
/// @note Modifichiamo tutti gli handler in modo che usino notify_intr() invece
/// di mettere il processo esterno direttamente in @ref esecuzione.
