...
// corpo della mia primitiva inutile
extern "C" void c_inutile(natq a, natq b) {
	flog(LOG_INFO, "c_inutile");
	natq val = a + b + esecuzione->precedenza;
	
	// restituisci
	esecuzione->contesto[I_RAX] = val;
}
